 ...
 */
public class ReportWorkOnForm extends javax.swing.JFrame {

    /**
     * Creates new form ReportDeptForm
     */
    public ReportWorkOnForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportWorkOnForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportWorkOnForm().setVisible(true);
            }
        });
    }
