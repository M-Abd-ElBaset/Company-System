 ...
 */
public class ReportDeptForm extends javax.swing.JFrame {

    /**
     * Creates new form ReportDeptForm
     */
    public ReportDeptForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportDeptForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportDeptForm().setVisible(true);
            }
        });
    }
